...
$query_students="SELECT COUNT(*)as count FROM user_details WHERE class_id=?";
...
$query="DELETE FROM classes WHERE t_id=?";
$stmt=mysqli_prepare($conn,$query);
mysqli_stmt_bind_param($stmt,"i",$class_id);
...
<strong>Enrolled Students:</strong> <?php echo $student_count;?>
</div>
