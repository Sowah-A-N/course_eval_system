 ...
 *  Classes are identified by name now (class codes were removed). */
...
<div class="card">
    ...
    <p class="card-subtitle">Import multiple students by choosing a department and uploading a correctly formatted CSV (.csv) or Excel (.xlsx) file. Student IDs are assigned automatically; students sign in with their email.</p>
