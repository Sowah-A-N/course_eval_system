...
if(empty($errors)){
$query="UPDATE classes SET class_name=?,class_code=? WHERE t_id=? AND department_id=?";
$stmt=mysqli_prepare($conn,$query);
mysqli_stmt_bind_param($stmt,"ssii",$class_name,$class_code,$class_id,$department_id);
