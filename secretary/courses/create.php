...
if(empty($errors)){
$query="INSERT INTO courses (course_code,name,credit_hours,level_id,semester_id,department_id) VALUES (?,?,?,?,?,?)";
$stmt=mysqli_prepare($conn,$query);
mysqli_stmt_bind_param($stmt,"ssiiii",$course_code,$name,$credit_hours,$level_id,$semester_id,$department_id);
