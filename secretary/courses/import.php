    ...
    if (!validate_csrf_token()) {
        ...
        if (!in_array($mime, $allowed_mime, true) && $ext !== 'csv') {
            ...
            if ($header !== false) {
                ...
                $missing = array_diff(['course_code', 'course_name', 'level_id', 'semester_id', 'credit_hours'], $header_lower);
            ...
            if (empty($parse_errors)) {
                ...
                while (($csv_row = fgetcsv($handle)) !== false) {
                    ...
                    [$course_code, $course_name, $level_id_raw, $semester_id_raw, $credit_hours_raw]
...
<div class="page-header">
    ...
    <p>Upload a CSV file to add multiple courses at once</p>
</div>
...
<div class="card">
    ...
    <p class="card-subtitle">Import multiple courses by uploading a correctly formatted CSV file.</p>
